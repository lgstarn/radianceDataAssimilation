module quadUtils_mod
    
    implicit none

    contains

    subroutine getGaussLegendreQuadPts(n,a,b,x,w)
        implicit none 
        ...
        !    1, Legendre,  (a,b)       1.0
        call cgqf(n,1,-999.d0,-999.d0,a,b,x,w)
    end subroutine

    subroutine getGaussHermiteQuadPts(n,x,w,a_in,b_in,alpha_in)
        implicit none 
        ...
        real(8), intent(in), optional :: a_in,b_in,alpha_in
        ...
        ! Default is "regular" Hermite, alpha = 0, a = 0, b = 1
        call cgqf(n,6,alpha,-999.d0,a,b,x,w)
    end subroutine
