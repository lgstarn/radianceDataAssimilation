...
#FC        :=  /usr/local/mpich-3.2.1_intel/bin/mpifort
FC        := mpifort
...
LFLAGS    += -lrttov12_main -lrttov12_coef_io -lrttov12_mw_scatt -lrttov12_other -lrttov12_mw_scatt_coef -lflapack -lfblas 
...
#LD        :=  /usr/local/mpich-3.2.1_intel/bin/mpifort
LD        := mpifort
